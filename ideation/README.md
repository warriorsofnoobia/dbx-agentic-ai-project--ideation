...
- [PROPOSAL 1: Platform-Engineering: Platform Prashanth](#proposal-1-platform-engineering-platform-prashanth)
  - [Context](#context)
  - [Purpose](#purpose)
...
- [PROPOSAL 2: Domain-Specific: Warehouse Reorder](#proposal-2-domain-specific-warehouse-reorder)
  ...
  - [4. Implementation Plan - 2 Weeks](#4-implementation-plan---2-weeks)
    - [Overview](#overview)
    - [Phase 1: Data Foundation (Days 1–5)](#phase-1-data-foundation-days-15)
      - [Day 1–2: Synthetic Dataset](#day-12-synthetic-dataset)
      - [Day 3–4: DLT Pipeline](#day-34-dlt-pipeline)
      - [Day 5: Demand Forecasting Model](#day-5-demand-forecasting-model)
    - [Phase 2: Agent Build (Days 6–9)](#phase-2-agent-build-days-69)
      - [Day 6–7: Agent Tools and Loop](#day-67-agent-tools-and-loop)
...
# PROPOSAL 1: Platform-Engineering: Platform Prashanth
\[2026-05-08\]
...
# PROPOSAL 2: Domain-Specific: Warehouse Reorder
\[2026-05-08\]
